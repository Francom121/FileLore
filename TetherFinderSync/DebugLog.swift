...
/// (`~/Library/Containers/com.tether.app.FinderSync/Data`), which is always
/// writable.
///
...
enum DebugLog {
    ...
    static let fileURL: URL = {
        FileManager.default.homeDirectoryForCurrentUser
            .appendingPathComponent("tether-badge-debug.log", isDirectory: false)
    }()

    /// The log is rolled once it exceeds this many bytes.
    private static let maxBytes: UInt64 = 256 * 1024

    private static let queue = DispatchQueue(label: "com.tether.app.FinderSync.DebugLog")
