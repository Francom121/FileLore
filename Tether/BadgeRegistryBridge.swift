...
///
/// The Finder Sync extension cannot read the `com.tether.note` xattr from
...
/// (`~/Library/Containers/com.tether.app.FinderSync/Data`), which the
...
enum BadgeRegistryBridge {
    ...
    static let darwinNotificationName = "com.tether.app.badgesChanged"
    ...
    private static var extensionContainerDataURL: URL? {
        ...
        let container = URL(fileURLWithPath: "/Users/\(userName)", isDirectory: true)
            .appendingPathComponent("Library/Containers/com.tether.app.FinderSync", isDirectory: true)
    ...
    static func refresh() {
        ...
        do {
            ...
            NSLog("Tether: failed to write badge registry (canonical): \(error.localizedDescription)")
        }
        ...
        do {
            ...
            NSLog("Tether: failed to write badge registry (extension container): \(error.localizedDescription)")
        }
    }
