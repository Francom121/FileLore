...
/// Quick Look preview for files carrying a Tether note.
///
...
final class PreviewViewController: NSViewController, QLPreviewingController {
    ...
    func preparePreviewOfFile(at url: URL) async throws {
        guard let note = try NoteStore.read(url: url) else {
            throw NSError(
                domain: "com.tether.app.QuickLook",
                code: 1,
                userInfo: [NSLocalizedDescriptionKey: "No Tether note attached to this file."]
            )
        }
